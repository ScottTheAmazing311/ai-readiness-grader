...
const POLL_TIMEOUT = 55000;         // 55s — leave room for subpage fetches within 120s Vercel limit
...
/**
 * Render a single page using Cloudflare Browser Rendering.
 * Falls back to raw HTTP fetch if the API isn't configured.
 */
